...
/*
 *json-server task
 *It starts Json-server as node Module
 * Json Data will be routed to 'src/data'
 */
gulp.task('json-server', function() {
    var server = jsonServer.create(),
        router = jsonServer.router(path.join('src/data', 'db.json')),
...
var jsfilelist = ['bower_components/jquery/dist/jquery.js',
    'src/scripts/components/variable.js',
    'src/scripts/components/globalheader.js',
    'src/scripts/components/modals.js',
    'src/scripts/components/index.js',
    'src/scripts/components/forgot-password.js',
    'src/scripts/components/profile-details-section.js',
    'src/scripts/components/supervisee-list.js',
    'src/scripts/components/edit-skill.js',
    'src/scripts/components/add-skill.js'
];
...
gulp.task('default', function(cb) {
    gulpSequence('clean', ['styles', 'scripts', 'images'], 'assemble', 'fonts', 'watch', 'browser-sync', 'json-server')(cb)
});
...
gulp.task('build', function(cb) {
    ...
    gulpSequence('clean', ['styles:prod', 'scripts:prod', 'images', 'fonts'], 'assemble')(cb)
});
